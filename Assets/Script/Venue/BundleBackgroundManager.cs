...
namespace YARG.Venue
{
    public class BundleBackgroundManager : MonoBehaviour
    {
        ...
        private void Export(GameObject root, BackgroundHelper.ExportType type, BuildTarget buildTarget = BuildTarget.StandaloneWindows)
        {
        ...
        [ContextMenu("Export Vocalist UWP")]
        public void ExportCharacterUWP()
        {
            var vocalist = _replaceableVocalist.gameObject;

            Export(vocalist, BackgroundHelper.ExportType.Character, BuildTarget.WSAPlayer);
        }

        [ContextMenu("Export Background UWP")]
        public void ExportBackgroundUWP()
        {
            Export(gameObject, BackgroundHelper.ExportType.Background, BuildTarget.WSAPlayer);
        }
#endif
    }
}
